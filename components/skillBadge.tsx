...
const CustomMarquee = ({
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Left Gradient Fade */}
      <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-[#F9F9F9] to-transparent z-10" />

      {/* Right Gradient Fade */}
      <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-[#F9F9F9] to-transparent z-10" />
...
const TechnologyIcon = ({
  ...
  return (
    <motion.div
      className="group relative flex flex-col items-center justify-center bg-[#FFF5F0] rounded-2xl p-6 shadow-lg border border-[#FFB67B]/20 hover:shadow-2xl transition-all duration-500 min-w-[100px]"
