...
export function ProjectCard({ title, description, tags, image, demoUrl, repoUrl }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute -inset-1 bg-gradient-to-r from-red-500/10 to-white/10 rounded-xl blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>

        <div className="relative h-full flex flex-col">
          <div className="relative overflow-hidden h-48">
            <div className="absolute inset-0 bg-gradient-to-b from-red-500/20 to-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"></div>
            <img
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              {demoUrl && (
                <Button size="sm" className="bg-red-500 hover:bg-red-600 border-0" asChild>
